...
const dictionaries: Record<SupportedLocale, Partial<AppTranslations>> = {
  ...
  ru: {
    ...
    historyRetention: 'Хранить историю',
  ...
  es: {
    ...
    historyRetention: 'Conservar el historial',
    never: 'Nunca',
    infoTitle: 'Info',
    download: 'Descargar',
    delete: 'Eliminar',
  ...
  sr: {
    ...
    historyRetention: 'Чување историје',
    never: 'Никада',
    infoTitle: 'Инфо',
    download: 'Преузми',
    delete: 'Обриши',
  ...
  he: {
    ...
    historyRetention: 'שמירת היסטוריה',
    never: 'לעולם לא',
    infoTitle: 'מידע',
    download: 'הורדה',
    delete: 'מחיקה',
  ...
  be: {
    ...
    historyRetention: 'Захоўваць гісторыю',
    never: 'Ніколі',
    download: 'Спампаваць',
    delete: 'Выдаліць',
  ...
  kk: {
    ...
    historyTitle: 'Тарих',
    historyRetention: 'Тарихты сақтау',
    never: 'Ешқашан',
    download: 'Жүктеу',
    delete: 'Жою',
    inUse: 'Қолданылуда',
  ...
  ky: {
    ...
    historyTitle: 'Тарых',
    historyRetention: 'Тарыхты сактоо',
    never: 'Эч качан',
    download: 'Жүктөө',
    delete: 'Өчүрүү',
    inUse: 'Колдонулууда',
  ...
  uz: {
    ...
    historyTitle: 'Tarix',
    historyRetention: 'Tarixni saqlash',
    never: 'Hech qachon',
  ...
  tg: {
    ...
    historyTitle: 'Таърих',
    historyRetention: 'Нигоҳ доштани таърих',
    never: 'Ҳеҷ гоҳ',
    download: 'Боргирӣ',
    delete: 'Нест кардан',
  ...
  hy: {
    ...
    historyRetention: 'Պահել պատմությունը',
    never: 'Երբեք',
    download: 'Ներբեռնել',
    delete: 'Ջնջել',
  ...
  az: {
    ...
    historyRetention: 'Tarixçəni saxlamaq',
    never: 'Heç vaxt',
    download: 'Yüklə',
    delete: 'Sil',
    inUse: 'İstifadədədir',
  ...
  ro: {
    ...
    historyRetention: 'Păstrează istoricul',
    never: 'Niciodată',
    download: 'Descarcă',
    delete: 'Șterge',
    inUse: 'În uz',
  ...
  tk: {
    ...
    historyTitle: 'Taryh',
    historyRetention: 'Taryhy saklamak',
    never: 'Hiç haçan',
    download: 'Ýükle',
    delete: 'Poz',
    inUse: 'Ulanylýar',
